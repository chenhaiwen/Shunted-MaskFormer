...
class MaskFormerHead(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        """
        super().__init__()
        # {'res2': ShapeSpec(channels=128, height=None, width=None, stride=4), 'res3': ShapeSpec(channels=256, height=None, width=None, stride=8),
        # 'res4': ShapeSpec(channels=512, height=None, width=None, stride=16), 'res5': ShapeSpec(channels=1024, height=None, width=None, stride=32)}
        input_shape = sorted(input_shape.items(), key=lambda x: x[1].stride) #按步长递增排序，⬆
